...
go.GraphObject.defineBuilder("HyperlinkText", function (args) {
  ...
  var url = go.GraphObject.takeBuilderArgument(args, undefined, function (x) {
  ...
  var text = go.GraphObject.takeBuilderArgument(args, null, function (x) {
    return typeof x === "string" || typeof x === "function";
  });
  ...
  // define the tooltip
  var tooltip = go.GraphObject.make(
    "ToolTip",
    go.GraphObject.make(
      go.TextBlock,
      { name: "TB", margin: 4 },
